...
#define STRING_CONFIG_H_AUTHOR "(Robert Clay, Printrbot XL)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 78.70, 78.80, 2000, 129 }
...
#define X_BED_SIZE 203.2
#define Y_BED_SIZE 203.2
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 3      // Number of LEDs on strip
